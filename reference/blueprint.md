...
- **2.2. Technical or Functional Constraints:**
  ...
  - ✅ A:
    ...
    - Extraction pipeline must use LLMWhisperer Text Extraction Service as the primary service for PDF table extraction.
...
- **5.2. Dependency-Risk Register** ⚠️
  ...
  | 15  | LLMWhisperer                                        | Service downtime, latency spikes, or API/plan changes may impact PDF table extraction. | M                  | H              | Wrap LLMWhisperer behind an internal extraction interface; monitor errors and usage.                                 | ENG   | Open   |

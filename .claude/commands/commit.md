---
description: Create an atomic git commit with conventional message format
...
If no files specified, commit changed files individually or by specific directory:
